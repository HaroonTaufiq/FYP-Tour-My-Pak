...
<p className="truncated-text text-white text-[24px] -mt-10 ml-2 font-extrabold  rounded-lg ">{description1 ? description1.split(' ').map(word => word.charAt(0).toUpperCase() + word.slice(1)).join(' ') : ""}</p>
...
<p className=" truncated-text text-white text-[24px] -mt-10 ml-2 font-extrabold  ">{description2 ? description2.split(' ').map(word => word.charAt(0).toUpperCase() + word.slice(1)).join(' ') : ""}</p>
<button className="flex h-12 justify-center items-center gap-1 self-stretch rounded-3xl px-4 py-2 bg-secondarycolor text-white mt-4" onClick={()=>check1()}>{details}</button>

</div>
<div>
<img src={i3} alt='travel img' className="w-[270px] h-[350px] object-cover rounded-xl"/>
<p className="truncated-text text-white text-[24px] -mt-10 ml-2 font-extrabold  ">{description3 ? description3.split(' ').map(word => word.charAt(0).toUpperCase() + word.slice(1)).join(' ') : ""}</p>
<button className="flex h-12 justify-center items-center gap-1 self-stretch rounded-3xl px-4 py-2 bg-secondarycolor text-white mt-4" onClick={()=>check1()}>{details}</button>

</div>
<div>
<img src={i4} alt='travel img' className="w-[270px] h-[350px] object-cover rounded-xl"/>
<p className="truncated-text text-white text-[24px] -mt-10 ml-2 font-extrabold ">{description4 ? description4.split(' ').map(word => word.charAt(0).toUpperCase() + word.slice(1)).join(' ') : ""}</p>
